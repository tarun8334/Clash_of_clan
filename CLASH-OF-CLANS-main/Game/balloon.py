...
class balloon:
    ...
    def move(self, a, b):
        ...
        y_direction = 1 if buildingPosition[1] > self.y else (-1 if buildingPosition[1] < self.y else 0)
        ...
        if self.y + y_direction > 0 and self.y + y_direction < 39 and self.x + x_direction > 0 and self.x + x_direction < 140:
            if C1DEAD:
        ...
        for i, j in directions:
            ...
            if b[adjacentY][adjacentX] == 'canon 1':
                ...
                if c1[0] <= 0:
                    ...
                    count[0]+=1
            elif b[adjacentY][adjacentX] == 'wall':
                b[adjacentY][adjacentX] = ' '
                a[adjacentY][adjacentX] = ' '
                ...
                if th[0] <= 0:
                    ...
                    count[0]+=1
            elif b[adjacentY][adjacentX] == 'wizard 1':
                w1[0] -= self.damage
                if w1[0] <= 0:
                    disappear.delete_ele(a, b, 'wizard 1')
                    count[0]+=1
            elif b[adjacentY][adjacentX] == 'wizard 2':
                w2[0] -= self.damage
                if w2[0] <= 0:
                    disappear.delete_ele(a, b, 'wizard 2')
                    count[0]+=1
            elif b[adjacentY][adjacentX] == 'canon 4':
                    c4[0] -= self.damage
                    if c4[0] <= 0:
                        disappear.delete_ele(a, b, 'canon 4')
                        count[0]+=1
            elif b[adjacentY][adjacentX] == 'wizard 3':
                w3[0] -= self.damage
                if w3[0] <= 0:
                    disappear.delete_ele(a, b, 'wizard 3')
                    count[0]+=1
            elif b[adjacentY][adjacentX] == 'wizard 4':
                w4[0] -= self.damage
                if w4[0] <= 0:
                    disappear.delete_ele(a, b, 'wizard 4')
                    count[0]+=1