    ...
    def damage(c1,c2,c3,h1,h2,h3,h4,h5,th,a,b,kp,x,y,count):
        ...
        if(b[y+1][x][0]=='t'):
            ...
            if(th[0]<=0):
                disappear.delete_ele(a,b,b[y+1][x])
                count[0]+=1
        if(b[y+1][x][0]=='w' and b[y+1][x][7]=='1'):
            w1[0]=w1[0]-kp
            os.system('aplay -q ./sounds/sword.wav& 2>/dev/null')
            if(w1[0]<=0):
                disappear.delete_ele(a,b,b[y+1][x])
                count[0]+=1
        if(b[y+1][x][0]=='w' and b[y+1][x][7]=='2'):
            w2[0]=w2[0]-kp
            os.system('aplay -q ./sounds/sword.wav& 2>/dev/null')
            if(w2[0]<=0):
                disappear.delete_ele(a,b,b[y+1][x])
                count[0]+=1
        if(b[y+1][x][0]=='w' and b[y+1][x][7]=='3'):
            w3[0]=w3[0]-kp
            os.system('aplay -q ./sounds/sword.wav& 2>/dev/null')
            if(w3[0]<=0):
                disappear.delete_ele(a,b,b[y+1][x])
                count[0]+=1
        if(b[y+1][x][0]=='w' and b[y][x-1][7]=='4'):
            w4[0]=w4[0]-kp
            os.system('aplay -q ./sounds/sword.wav& 2>/dev/null')
            if(w4[0]<=0):
                disappear.delete_ele(a,b,b[y+1][x])
                count[0]+=1
        if(b[y+1][x][0]=='c' and b[y+1][x][6]=='4'):
            c4[0]=c4[0]-kp
            os.system('aplay -q ./sounds/sword.wav& 2>/dev/null')
            if(c4[0]<=0):
                disappear.delete_ele(a,b,b[y+1][x])
        ...
        if(b[y-1][x][0]=='w' and b[y-1][x][7]=='3'):
            ...
            if(w3[0]<=0):
                disappear.delete_ele(a,b,b[y-1][x])
                count[0]+=1
        if(b[y-1][x][0]=='w' and b[y-1][x][7]=='4'):
            w4[0]=w4[0]-kp
            os.system('aplay -q ./sounds/sword.wav& 2>/dev/null')
            if(w4[0]<=0):
                disappear.delete_ele(a,b,b[y-1][x])
        ...
        if(b[y][x+1][0]=='t'):
            ...
            if(th[0]<=0):
                disappear.delete_ele(a,b,b[y][x+1])
                count[0]+=1
        if(b[y][x-+1][0]=='w' and b[y][x+1][7]=='1'):
            w1[0]=w1[0]-kp
            os.system('aplay -q ./sounds/sword.wav& 2>/dev/null')
            if(w1[0]<=0):
                disappear.delete_ele(a,b,b[y][x+1])
                count[0]+=1
        if(b[y][x+1][0]=='w' and b[y][x+1][7]=='2'):
            w2[0]=w2[0]-kp
            os.system('aplay -q ./sounds/sword.wav& 2>/dev/null')
            if(w2[0]<=0):
                disappear.delete_ele(a,b,b[y][x+1])
                count[0]+=1
        if(b[y][x+1][0]=='w' and b[y][x+1][7]=='3'):
            w3[0]=w3[0]-kp
            os.system('aplay -q ./sounds/sword.wav& 2>/dev/null')
            if(w3[0]<=0):
                disappear.delete_ele(a,b,b[y][x+1])
                count[0]+=1
        if(b[y][x+1][0]=='w' and b[y][x+1][7]=='4'):
            w4[0]=w4[0]-kp
            os.system('aplay -q ./sounds/sword.wav& 2>/dev/null')
            if(w4[0]<=0):
                disappear.delete_ele(a,b,b[y][x+1])
                count[0]+=1
        if(b[y][x+1][0]=='c' and b[y][x+1][6]=='4'):
            c4[0]=c4[0]-kp
            os.system('aplay -q ./sounds/sword.wav& 2>/dev/null')
            if(c4[0]<=0):
                disappear.delete_ele(a,b,b[y][x+1])
