...
class board:
    ...
    def print_board(self,king_movement,c1,c2,c3,h1,h2,h3,h4,h5,th,b,health, BarbList,w1,w2,w3,w4):
        for i in range(self.__rows):
            for j in range(self.__columns):
                if (b[i][j]=='townhall') and th[0]>50:
                    ...
                    print(Fore.GREEN + self.__grid[i][j] + Fore.RESET, end="")
                elif b[i][j]=='wizard 1' and w1[0]>50:
                    print(Fore.GREEN + self.__grid[i][j] + Fore.RESET, end="")
                elif b[i][j]=='wizard 2' and w2[0]>50:
                    print(Fore.GREEN + self.__grid[i][j] + Fore.RESET, end="")
                elif b[i][j]=='wizard 3' and w3[0]>50:
                    print(Fore.GREEN + self.__grid[i][j] + Fore.RESET, end="")
                elif b[i][j]=='wizard 4' and w4[0]>50:
                    print(Fore.GREEN + self.__grid[i][j] + Fore.RESET, end="")
                    ...
                    print(Fore.YELLOW + self.__grid[i][j] + Fore.RESET, end="")
                elif b[i][j]=='wizard 1' and w1[0]>20:
                    print(Fore.YELLOW + self.__grid[i][j] + Fore.RESET, end="")
                elif b[i][j]=='wizard 2' and w2[0]>20:
                    print(Fore.YELLOW + self.__grid[i][j] + Fore.RESET, end="")
                elif b[i][j]=='wizard 3' and w3[0]>20:
                    print(Fore.YELLOW + self.__grid[i][j] + Fore.RESET, end="")
                elif b[i][j]=='wizard 4' and w4[0]>20:
                    print(Fore.YELLOW + self.__grid[i][j] + Fore.RESET, end="")
                elif (b[i][j]=='townhall') and th[0]<=20:
